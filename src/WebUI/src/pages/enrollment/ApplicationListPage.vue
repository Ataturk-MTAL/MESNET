<template>
  <q-page padding>
    ...
    <div class="flex flex-center q-pa-xl text-grey-6 column">
      ...
      <div class="text-subtitle1">Başvuru yönetimi için ilgili sayfaları kullanın</div>
      <div class="row q-gutter-sm q-mt-md">
        <q-btn color="primary" icon="person" label="Öğrenciler" :to="{ name: 'StudentList' }" />
        <q-btn color="secondary" icon="business" label="İşletmeler" :to="{ name: 'CompanyList' }" />
      </div>
    </div>
  </q-page>
</template>
