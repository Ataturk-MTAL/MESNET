...
public static class UploadTerminationDocumentHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var objectPath = $"contracts/{command.ContractId:N}/termination_{timestamp}.pdf";

        // 5. Metadata
        var metadata = new Dictionary<string, string>
        {
            ["x-amz-meta-contract-id"] = command.ContractId.ToString(),
            ["x-amz-meta-document-type"] = "Termination",
