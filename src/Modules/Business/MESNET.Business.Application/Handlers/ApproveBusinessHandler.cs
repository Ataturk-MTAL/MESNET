...
public static class ApproveBusinessHandler
{
        ...
        ApproveBusiness command, IDocumentSession session, ICurrentUserService currentUser)
    {
        ...
        return new BusinessApproved(business.Id, business.InstitutionId, business.Name, business.Address, business.Location, currentUser.GetFullName(), business.ApprovedAt.Value);
    }
}
