...
{
    public static BusinessRegistered Handle(RegisterBusiness command, IDocumentSession session)
    {
        ...
        return new BusinessRegistered(business.Id, business.Name, business.Location, business.Source);
    }
}
