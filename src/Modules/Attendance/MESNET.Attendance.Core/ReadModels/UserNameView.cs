...
///
/// <para>Denetim alanları (<c>UpdatedById</c> vb.) yalnız token'dan gelen kullanıcı
/// kimliğini saklar; serbest metin ad SAKLANMAZ — aksi hâlde işlemi yapan istemci denetim
/// satırındaki aktörü kendisi yazardı. Ad, sorgu tarafında bu view'dan çözülür.</para>
///
