...
/// <summary>
/// Personel mükerrer kaydı koruması (#190).
///
...
///
/// <para>Bu sınıf MÜKERRER kaydı kilitler. Boş ad ayrı bir iştir: kök nedeni Keycloak
/// kullanıcılarının <c>firstName</c>/<c>lastName</c> alanlarının hiç bulunmaması; doğrulama
/// eklemek önce o kaynağın düzeltilmesini gerektiriyor (#190).</para>
/// </summary>
